...
class POS_svf(nn.Module):
    ...
    def from_config(cls, cfg):
        ...
        output_shape = {
            ...
            'res4': ShapeSpec(channels=1024, stride=8),
            'res5': ShapeSpec(channels=2048, stride=8),
        }
    ...
    def forward(self, batched_inputs):
        ...
        features = {'res5':query_feat_4, 'res4':query_feat_3, 'res3':query_feat_2, 'res2':query_feat_1}
