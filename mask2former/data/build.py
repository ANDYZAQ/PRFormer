...
def get_detection_dataset_dicts(
    names, filter_empty=True, min_keypoints=0, proposal_files=None, img_path=None,
):
    """
    ...
    Args:
        ...
        img_path (str): if given, the path to the image folder. If not given, the path
...
def _train_loader_from_config(cfg, mapper=None, *, dataset=None, sampler=None):
    if dataset is None:
        dataset = get_detection_dataset_dicts(
            ...
            img_path=cfg.DATASETS.IMGPATHROOT,
        )
