...
__all__ = ["FewShotDatasetMapper_u"]



class FewShotDatasetMapper_u:
    """
    ...
    def __init__(
        ...
        *,
        ...
        if root=="./":
            logger.info("Load from BAM dataset.")
            fss_list_root = 'lists/{}/fss_list/{}/'.format(dataname, 'train' if is_train else 'val')
