...
class FewShotDatasetMapper_stage2:
    ...
    def __call__(self, dataset_dict):
        ...
        # label = sem_seg_gt_.clone().numpy()
        # label_class = np.unique(label).tolist()
        # print(label_class, sem_seg_gt_.shape)
    ...
    def get_sup_img_pairs(self, class_chosen, image_path):
        ...
        for k in range(self.shot):  
            ...
            # print('sup:', os.path.isfile(support_image_path), os.path.exists(support_label_path), support_image_path, support_label_path)
            assert os.path.isfile(support_image_path), support_image_path
