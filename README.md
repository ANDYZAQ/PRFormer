...
This is the official implementation of the paper [PRFormer: Matching Proposal and Reference Masks by Semantic and Spatial Similarity for Few Shot Semantic Segmentation]().
